...
Where $L_1$ refers to The width corresponding to the indentation caused by each normal load.($b$ and $L_1$ are specifically indicated in Figure 6)
...
Through calculation, the wear width $L_1$ caused by each applied load is determined to be 0.1±0.01. For the sake of simplification in subsequent calculations, $L_1$ is treated as a constant value of 0.1.
...
\textbf{!!WARNING Figure n is a placeholder, please replace it with the actual figure WARNING!!}
