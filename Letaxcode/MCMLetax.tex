...
\begin{figure}[h]  % 图片
  ...
  \caption{14-Staircase section Worn Pit Profile Line varies with the ratio of the number of passengers on the upward journey} \label{fig:2}  % 标题与标签
  \end{figure}  % 图片结束
